...
def set_up_dataset(fdir, runname, olddata, name = 'Cooling', data_shape = (29, nz+1, 161), metals=False):
...
#    mf_name        = 'hm_2011_sh'
    ...
    metal_only_dir = 'fg_2011_smoothing/'
    metal_only_name = 'fg_2011_shield_metal_only'
    mf_dir = 'fg_2011_shield_combined_mf_fixed/'
    mf_name = 'fg_2011_shield_combined_mf'

    cloudy_table = 'CloudyData_UVB=FG2011.h5'
    output       = 'CloudyData_UVB=FG2011_shielded.h5'

    original_table = h5.File('/home/aemerick/code/grackle-emerick/input/' + cloudy_table,'r')
